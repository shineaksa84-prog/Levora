...
export default function Sidebar() {
    ...
    return (
        <div className="w-64 glass-sidebar bg-white/60 flex flex-col h-full shadow-2xl relative z-50">
            <div className="p-6 border-b border-white/20 bg-gradient-to-br from-indigo-50/50 to-purple-50/50 backdrop-blur-md">
                <div className="flex items-center gap-3">
                    <div className="gradient-primary p-2.5 rounded-xl shadow-glow-sm hover:scale-105 transition-transform duration-300">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-500 font-bold tracking-widest uppercase">AI-Powered HR</p>
                    </div>
                </div>
            </div>
                ...
                {navigation.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <item.icon className={cn("w-5 h-5 transition-transform group-hover:scale-110", isActive ? "text-indigo-600" : "text-gray-400 group-hover:text-gray-600")} />
                            {item.name}
                        </Link>
                    );
                })}
            ...
            <div className="p-4 border-t border-white/30 bg-white/30 backdrop-blur-sm">
                <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-white/40 transition-colors cursor-pointer group">
                    <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-violet-500 to-fuchsia-500 p-[2px] shadow-glow-sm group-hover:shadow-glow transition-shadow">
