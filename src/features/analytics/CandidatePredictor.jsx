...
import { Users, TrendingUp, AlertCircle, CheckCircle2, MoreHorizontal, ArrowUpRight } from 'lucide-react';

const CANDIDATES = [
    { id: 1, name: 'Michael Chen', role: 'Senior Backend Dev', probability: 92, status: 'Active', signals: ['Short Notice Period', 'High Engagement'], priority: 'High' },
    { id: 2, name: 'Sarah Miller', role: 'Product Manager', probability: 78, status: 'Passive', signals: ['Open to opportunities'], priority: 'Medium' },
    { id: 3, name: 'James Wilson', role: 'DevOps Engineer', probability: 45, status: 'Passive', signals: ['Recent Promotion'], priority: 'Low' },
    { id: 4, name: 'Emily Davis', role: 'UI/UX Designer', probability: 88, status: 'Active', signals: ['Application viewed twice'], priority: 'High' },
    { id: 5, name: 'Robert Taylor', role: 'Frontend Dev', probability: 65, status: 'Active', signals: [], priority: 'Medium' },
];
            ...
            <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">AI-driven insights to prioritize your outreach efforts.</p>
                    </div>
                                    ...
                                    <td className="px-4 py-4">
                                        <div className="flex items-center gap-2">
                                            <div className="flex-1 w-24 h-2 bg-muted rounded-full overflow-hidden">
                                                <div
                                                    className={`h-full rounded-full ${candidate.probability > 80 ? 'bg-green-500' : candidate.probability > 60 ? 'bg-yellow-500' : 'bg-red-500'}`}
